---
title: "PSY4210: My First Quarto File"
author: 
  - name: Joshua F. Wiley
...
[https://jwiley.github.io/MonashHonoursStatistics/MyFirstQuarto.qmd](https://jwiley.github.io/MonashHonoursStatistics/MyFirstQuarto.qmd).

# Quarto Files

Quarto files can combine `R` code for data analysis with markdown, a
markup language that adds some additional text to plain text to manage
formating. More information is here: [https://quarto.org/](https://quarto.org/).

For example, asterisks can be used around words to
...
the great parts of using Quarto files. You may do some analysis
...
this by `render`ing the Quarto file. You can do this through
code, but we'll use `RStudio` or `Positron` to help us do it.
