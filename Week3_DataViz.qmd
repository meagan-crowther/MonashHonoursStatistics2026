...
<https://github.com/meagan-crowther/MonashHonoursStatistics2026/blob/master/Week3_DataViz.qmd>
...
A simple way would be to calculate the percentage of `sex = "female"` in
...
following code. We calculate the average number of `sex == "female"` which
...
plots we went over earlier. To that we add a linear regression line to help
...
:::{.callout-note collapse="true"}
Because we did not store the results of Stress
...
Another aspect we could improve: there is no necessary ordering of
