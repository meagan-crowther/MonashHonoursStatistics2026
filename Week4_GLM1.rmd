...
You can view, download or pull the `R`markdown file for this content here
...
`r margin_note("You might find this page helpful for further explanation of dummy coding: https://stats.oarc.ucla.edu/other/mult-pkg/faq/general/faqwhat-is-dummy-coding/")`
...
`r formatPval(coef(summary(m3))["sexfemales", "Pr(>|t|)"], d = 2, includeP = TRUE)`.
